                    ...
                    <ul class="sidebar-menu">
                       ...
                       <!--<?php if($hasAccesstoAppointment){?>
                        <li class="treeview <?php echo $appointmentTab;?>">
                            <a href="#">
                                <i class="fa fa fa-male"></i> <span>Create Appointment</span>
                        ...
                        <?php if($hasAccesstoOPDRegistration == TRUE && $hasAccesstoOPDEnquiry == TRUE){?>
                            <li class="treeview <?php echo $opd;?>">
                                <a href="#">
                                    <i class="fa fa-h-square"></i><span>Out Patient</span>
                                    <i class="fa fa-angle-left pull-right"></i>
                                </a>
                                <ul class="treeview-menu">
                        ...
                        <?php if($hasAccesstoBilling){?>
                            <li class="treeview <?php echo $billing;?>">
                                ...
                                <ul class="treeview-menu">
                                    <?php if($hasAccesstoPOS){?><li><a href="<?php echo base_url()?>app/pos/"><i class="fa fa-angle-double-right"></i>POS</a></li><?php }?>
                       ...
                       <li class="treeview <?php echo $admin;?>">
                            ...
                            <ul class="treeview-menu">
                                <?php if($hasAccesstoAdminCompanyInfo){?><li <?php echo $company_information;?>><a href="<?php echo base_url()?>app/company_information"><i class="fa fa-angle-double-right"></i>Hospital Information</a></li> <?php }?>
