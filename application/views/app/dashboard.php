        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section>
                	<table>
                		<tr>
                			<td><p style="margin-left:30px;"></p></td>
                			<td>
                            ...
                            <td>
                            	<div class="box-header">
                                    <h3 class="box-title"><a href="<?php echo base_url();?>app/opd/search_result" class="btn btn-primary" style="background-color: black;"><i class="fa fa-plus"></i> Add New OP</a></h3>
                                </div>
                            </td>
                            <td><p style="margin-left: 30px;"></p></td>
                            <td>
								<div class="box-header">
                                    <h3 class="box-title"><a href="<?php echo base_url();?>app/ipd/admit_patient" class="btn btn-primary" style="background-color: green;"><i class="fa fa-plus"></i> Admit New Patient</a></h3>
                                </div>
                            </td>	
                            <td><p style="margin-left: 30px;"></p></td>
                            <td>
								<div class="box-header">
                                    <h3 class="box-title"><a href="<?php echo base_url();?>app/ipd/index" class="btn btn-primary" style="background-color: voilet;"><i class="fa fa-plus"></i> Disharge Patient</a></h3>
                                </div>
                            </td>	
                            <td><p style="margin-left: 30px;"></p></td>
                            <td>
								<div class="box-header">
                                    <h3 class="box-title"><a href="<?php echo base_url();?>app/pos" class="btn btn-primary" style="background-color: purple;"><i class="fa fa-plus"></i> New Bill</a></h3>
                                </div>
                            </td>	
                            <td><p style="margin-left: 30px;"></p></td>
                            <td>
								<div class="box-header">
                                    <h3 class="box-title"><a href="<?php echo base_url();?>app/patient/index" class="btn btn-primary" style="background-color: red;"><i class="fa fa-plus"></i> Search Patients</a></h3>
                                </div>
                            </td>	
							<td><p style="margin-left: 30px;"></p></td>
                            <td>
								<div class="box-header">
                                    <h3 class="box-title"><a href="<?php echo base_url();?>app/pos?command=lab" class="btn btn-primary" style="background-color: purple;"><i class="fa fa-plus"></i> New Lab Bill</a></h3>
                                </div>
                            </td>	
                        </tr>                			
                	</table>
