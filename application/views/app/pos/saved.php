                        	...
                        	<div class="box-body">
                                ...
                                <?php }else{?>
                                   ...
                                   <!-- <a class="btn btn-app" onClick="alert('Invoice has already receipt.You cannot modify this transaction.');"><i class="fa fa-hand-o-down"></i> 1-Click Billed</a>-->
                                	...
                                	<a class="btn btn-app" href="<?php echo base_url()?>app/opd/printOR/<?php echo $getOPDPatient->IO_ID?>/<?php echo $patientInfo->patient_no?>/<?php echo $headerInv->invoice_no?>" target="_blank"><i class="fa fa-print"></i> Consultation Fee</a>
                                	<a class="btn btn-app" href="<?php echo base_url()?>app/opd/printOR2/<?php echo $getOPDPatient->IO_ID?>/<?php echo $patientInfo->patient_no?>/<?php echo $headerInv->invoice_no?>" target="_blank"><i class="fa fa-print"></i> Print Bill</a>
                                <?php }?>
