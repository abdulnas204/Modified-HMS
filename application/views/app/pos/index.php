                                	 ...
                                	 <span id="patientDetials">
                                        ...
                                        <tr>
                                    		...
                                    		<td>
                                                ...
                                                <tr>
                                                	<td><strong>In/Out Patient No</strong></td>
                                                    <td>-</td>
                                                </tr>
                                                <tr>
                                                	<td><strong>Patient Name</strong></td>
                    ...
                    <div class="col-md-9">
                    	<div class="box box-primary">
                        	<div class="box-body">
                                ...
                                <a class="btn btn-app" data-toggle="modal" id="addNewItem" data-target="#myModal"><i class="fa fa-plus"></i> Add Item</a>
                                ...
                                <a class="btn btn-app" onClick="alert('Please save current transaction to print Consultation Fee');"><i class="fa fa-print"></i> Consultation Fee</a>
                                <a class="btn btn-app" onClick="alert('Please save current transaction to print Hospital Charges');"><i class="fa fa-print"></i> Print Bill - All</a>
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    	...
    	if(getParameterByName("command") == "lab"){
    		document.getElementById("addNewItem").click();
			document.getElementById("category").value = 42;    	
			showDrugName(42);
    	}
    }
  }
    ...
    <div class="modal fade" id="doctorListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control input-sm" style="width: 100%;" required placeholder="Value" onkeyup="compute(this.value)" name="valueFee" id="valueFee" value="200">
                            </td>
                        </tr>
                        <tr>
                            <td>Total Fee <font color="#FF0000">*</font></td>
                            <td>
                                <input type="text" style="font-size:26px; width:100%; background-color:rgba(243, 215, 16, 0.27);;" readonly="" name="totalFee" id="totalFee" value="200">
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="modal-footer">
                    <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
                    <button type="button" class="btn btn-primary" onClick="saveDoctorFee()" name="btnSaveDoctorFee" id="btnSaveDoctorFee" data-dismiss="modal">Save</button>
                </div>
