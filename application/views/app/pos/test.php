...
<body>
	<header>
		<a href="http://manos.malihu.gr/jquery-custom-content-scroller/" class="logo"><img src="<?php echo base_url()?>public/scrollbar/logo.png" alt="jQuery custom scrollbar" /></a>
		<hr />
	</header>
	...
	<script>
	window.jQuery
	document.write('<script src="<?php echo base_url()?>public/scrollbar/js/minified/jquery-1.11.0.min.js"><\/script>')
    </script>
