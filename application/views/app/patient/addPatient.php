                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="88%">
                                                        	<!--<select name="title" id="title" class="form-control input-sm" style="width: 100px;">
																...
																?>
																<input type="radio" name="title" id='' value="<?php echo $UserTitles->param_id;?>" ><?php echo $UserTitles->cValue;?></input>
<!--                                                            	<option value="<?php echo $UserTitles->param_id;?>" <?php echo $selected;?>><?php echo $UserTitles->cValue;?></option> -->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            <td width="14%">Mobile<font color="#FF0000">*</font></td>
                                                            <td width="86%">
                                                                <?php echo form_input('mobile',set_value('mobile'),'id="mobile" class="form-control input-sm" placeholder="Phone No (Mobile)" style="width: 250px;" required');?>
                                                            </td>
                                                        </tr>
