...
class Reports_model extends CI_Model{
	...
	public function outpatient(){
		$this->db->select("
			...
			A.IO_ID,
			A.patient_no,
			concat(C.cValue,' ',B.firstname,' ',B.lastname) as name,
			concat(E.cValue,' ',D.firstname,' ',D.lastname) as consultant,
			concat(G.cValue,' ',F.firstname,' ',F.lastname) as refferal,
			H.dept_name,
			A.nStatus
		",false);
		...
		$where = "A.InActive = 0 
				...
				and A.patient_type = 'OPD' and A.nStatus = 'Discharged'";
